...
const Startani = () => {
  ...
  return (
    <div className={`text-black ${none} overflow-hidden font-bold text-[5rem] transition-[7s] flex items-center bg-white w-full absolute [text-shadow:0_0_0.2rem_black] top-[0] left-[] h-screen justify-center setBac`}>
    <div className={`${bounce} flex`}>
